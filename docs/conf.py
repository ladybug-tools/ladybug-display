...
latex_documents = [
    (master_doc, 'ladybug-display.tex', 'ladybug-display Documentation',
...
man_pages = [
    (master_doc, 'ladybug-display', 'ladybug-display Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ladybug-display', 'ladybug-display Documentation',
     author, 'ladybug-display', 'One line description of project.',
     'Miscellaneous'),
]
